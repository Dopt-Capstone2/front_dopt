    ...
    override fun onCreateView(
        ...
        animalDatas.apply {
            add(Animal("2002(년생)", "00 00시 00군 00도 00읍 00", "채현 보호소", "00-00-00", "채현","연한 갈색", null,
                R.drawable.dog_num_one,20220523, "", "[개]포메라니안","중성화X",20220602, "", 20220523, "", "", "", "보호중", "암컷", "추위를 잘 탐", "2(kg)" ))
            add(Animal("2002(년생)", "00 00시 00군 00도 00읍", "채현이 보호소", "00-00-000", "채현이","갈색", null,
                R.drawable.cat_num_one,20220523, "", "[고양이]두두두","중성화O",20220602, "", 20220523, "", "", "", "보호중", "암컷", "추위를 잘 탐", "3(kg)" ))
